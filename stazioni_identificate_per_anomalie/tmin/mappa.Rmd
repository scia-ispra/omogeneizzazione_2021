---
title: Stazioni per anomalia di temperatura minima annuale Italia
...
read_delim(list.files(pattern=".+_serie_selezionate_cluster_.+csv"),delim=";",col_names = TRUE,col_types = YYMMDD_TYPE)->dati
