---
title: Numero di breakpoints, serie tmin
...
leggi_file(pattern="^Tmin.+csv",output = "",delim=",") %>%
  purrr::map_dbl(.f=nrow)->numero_breakpoints

leggi_file(pattern="^Tmin.+csv",output = "_dfr",delim=",") %>%
...
```{r}
read_delim("tmin_serie_selezionate_cluster_analysis_tmin_1961_2020.csv",delim=";",col_names = TRUE,col_types = YYMMDD_TYPE)->dati
...
### Numero di breakpoints per anno (1961:2018)
