...
ggplot()+
  ...
  geom_sf(data=italia,fill="transparent")+
  scale_fill_scico(palette="imola",na.value="transparent",limits=c(0,1),breaks=seq(0,1,by=0.2),guide=guide_colorbar(barheight = unit(8,"cm")))+
  theme_void()+
