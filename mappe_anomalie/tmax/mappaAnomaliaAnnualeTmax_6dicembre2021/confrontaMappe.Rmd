...
list.files(pattern="^.+MediaPesata.tif")->ffile
...
ggplot()+
  ...
  scale_fill_scico(palette="vik",na.value="transparent",limits=c(-3,3),breaks=seq(-3,3,by=0.25),guide=guide_colorbar(barheight = unit(8,"cm")))+
  theme_void()+
...
ggplot()+
  ...
  geom_sf(data=italia,fill="transparent")+
  scale_fill_scico(palette="imola",na.value="transparent",limits=c(0,1.5),breaks=seq(0,1.5,by=0.25),guide=guide_colorbar(barheight = unit(8,"cm")))+
  theme_void()+
