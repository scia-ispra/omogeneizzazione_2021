---
title: Trends delle serie di tmin (serie omogeneizzate)
date: "`r Sys.Date()`"
...
read_delim("intersected_tmax_tmintmin_serie_selezionate_cluster_analysis_tmin_1961_2020_senza_limitrofe.csv",delim=";",col_types = YYMMDD_TYPE)->dati
...
c(2,3,4,5,6,7,8,10,11,12,17)->listaClusters
...
e_arrange(listaGrafici[[1]],listaGrafici[[2]],listaGrafici[[3]],listaGrafici[[4]],listaGrafici[[5]],listaGrafici[[6]],listaGrafici[[7]],listaGrafici[[8]],listaGrafici[[9]],listaGrafici[[10]],listaGrafici[[11]],row=6,cols = 2)
```