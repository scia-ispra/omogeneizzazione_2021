---
title: Trends delle serie di tmin (serie raw)
date: "`r Sys.Date()`"
...
read_delim("raw_intersected_tmax_tmintmin_serie_selezionate_cluster_analysis_tmin_1961_2020_senza_limitrofe.csv",delim=";",col_types = YYMMDD_TYPE)->dati
